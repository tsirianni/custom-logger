...
class Logger {
  ...
  errorEventHandler(error) {
    this.logError('An error occured when writing your log to the specified file:', error);
  }
  ...
  logToFile(formattedMetadata, message, path, details = null) {
    if (!path) {
      throw new Error('A path must be especified to log to files');
    }
  ...
  logInfo(message, details = null, path = null) {
    ...
    const logToFile = this.output === 'file';
